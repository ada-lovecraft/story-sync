...
import { Badge } from "../_components/ui/card";
...
export default function RoundsPage() {
    ...
    const totalLines = roundsQuery.data?.reduce((sum, round) => sum + round.lineCount, 0) || 0;
    const averageLinesPerRound = totalRounds > 0 ? (totalLines / totalRounds).toFixed(2) : "0";

    // Loading state
    const isLoading = chatLogQuery.isLoading || roundsQuery.isLoading || parseRoundsMutation.isLoading;
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    <div className="space-x-2">
                                        <Button
                                            ...
                                            disabled={parseRoundsMutation.isLoading || !chatLogQuery.data?.cleanedContent}
                                        >
                                            {parseRoundsMutation.isLoading ? (
                                                <>
