...
export default function RoundsPage() {
    ...
    // Try to get chatLogId, or fallback to 'id' parameter for compatibility
    const chatLogId = searchParams?.get("chatLogId") ?? searchParams?.get("id") ?? "";

    // Log the query parameters for debugging
    useEffect(() => {
        console.log("Query params:", {
            chatLogId: searchParams?.get("chatLogId"),
