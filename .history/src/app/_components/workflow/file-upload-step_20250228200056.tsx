...
export function FileUploadStep() {
    ...
    const { isLoading: isLoadingDocuments } = api.chatLog.getAll.useQuery(undefined, {
        onSuccess: (data) => {
            log("Documents loaded", { count: data?.length });
            setDocuments(
                data?.map(log => {
                    return {
                        id: log.id,
        ...
        onError: (error) => {
            err("Error loading documents", { error });
            toast({
                title: "Error",
    ...
    const uploadMutation = api.chatLog.uploadChatLog.useMutation({
        onSuccess: () => {
            log("File uploaded successfully");
            // Refresh the document list
            void api.chatLog.getAll.invalidate();
    ...
    const deleteMutation = api.chatLog.delete.useMutation({
        onSuccess: () => {
