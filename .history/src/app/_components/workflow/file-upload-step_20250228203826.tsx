...
// Allowed file types
const ALLOWED_FILE_TYPES = ["text/plain", "application/json", "text/markdown"];
...
export function FileUploadStep() {
    ...
    // Upload Mutation 
    const uploadMutation = api.workflow.createChatLog.useMutation({
                    ...
                    <Tabs defaultValue="upload" value={activeTab} onValueChange={(v) => setActiveTab(v as "upload" | "select")}>
                        ...
                        <TabsContent value="upload">
                            <FileDropZone
                                ...
                                acceptedTypes={ALLOWED_FILE_TYPES.join(",")}
                            />
                        </TabsContent>
