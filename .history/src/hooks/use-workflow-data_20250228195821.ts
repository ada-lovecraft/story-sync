...
export function useWorkflowData() {
    ...
    const goToNextStep = () => {
        ...
        if (nextStep <= Number(WorkflowStep.CHAPTER)) {
            setCurrentStep(nextStep as WorkflowStep);
    ...
    const goToPreviousStep = () => {
        ...
        if (prevStep >= Number(WorkflowStep.UPLOAD)) {
            setCurrentStep(prevStep as WorkflowStep);
