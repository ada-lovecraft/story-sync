...
import { useWorkflowData, type WorkflowStep } from "@/hooks/use-workflow-data";
...
export function FileUploadStep() {
    ...
    const { goToStep, setActiveFileId } = useWorkflow();
    ...
    const handleSelectDocument = useCallback((doc: Document) => {
        ...
        // Update the active file ID in the workflow context
        ...
        setActiveTab("select");
    }, [setNextEnabled, updateWorkflowData, setActiveFileId, setActiveTab, setSelectedDocument]);
    ...
    const handleContinueToClean = useCallback(() => {
        ...
        // Ensure workflow data is updated using useWorkflowData
        updateWorkflowData({
            selectedDocumentId: selectedDocument.id,
            selectedDocumentName: selectedDocument.name,
        });

        // Ensure active file ID is set in the workflow context
        setActiveFileId(selectedDocument.id);

        // Navigate to the Clean step using the workflow provider
        goToStep("CLEAN");
    }, [selectedDocument, updateWorkflowData, setActiveFileId, goToStep]);
            ...
            <Card className="w-full">
                ...
                <CardContent>
                    ...
                    {selectedDocument && !isPreviewMode && (
                        <div className="mt-6">
                            <Alert className="mb-4 border-green-500 bg-green-50 dark:bg-green-950/20 dark:border-green-900">
